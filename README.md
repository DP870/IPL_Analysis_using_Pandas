Data Pipeline Design and Analysis Using IPL Data  
Overview
You are building a data analysis pipeline on IPL datasets using Pandas.
The goal is not just analysis, but to simulate a real-world data workflow:
